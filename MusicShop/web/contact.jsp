...
<html>
    <head>
        ...
        <title>LIÊN HỆ CHÚNG TÔI - FPT ACOUSTIC SHOP</title>
...
<link href='//fonts.googleapis.com/css?family=Lato:400,100,300,700,900' rel='stylesheet' type='text/css'>
	...
	<div class="container">
		...
		<h3 class="animated wow fadeInRight" data-wow-delay=".5s"><a href="index.html">Trang Chủ</a><label>/</label>Liên Hệ</h3>
			...
			<div class="col-md-4 contact-grids">
				<div class=" contact-grid animated wow fadeInLeft" data-wow-delay=".5s">
					<div class="contact-grid1">
						...
						<div class="contact-grid3">
							<h4>Địa Chỉ</h4>
							Toà Nhà Gamma Campus FPT Đà Nẵng <span>Q.Ngũ Hành Sơn, TP. Đà Nẵng.</span></p>
						</div>
					</div>
				</div>
				...
				<div class=" contact-grid animated wow fadeInRight" data-wow-delay=".5s">
					<div class="contact-grid1">
						...
						<div class="contact-grid3">
							<h4>Email</h4>
							<p><a href="contactto:info@example.com">contact@fpt.edu.vn</a><span><a href="contactto:info@example.com">lienhe@fpt.edu.vn</a></span></p>
						</div>
					</div>
				</div>
