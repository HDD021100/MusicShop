...
public class BrandGet {
    public ArrayList<Brand> getListBrand() throws SQLException {
        ...
        String sql = "SELECT * FROM musicshop.brand";
    ...
    public Brand getBrand(long brandID) throws SQLException {
        Connection connection = DBConnect.getConnecttion();
        String sql =  "SELECT * FROM musicshop.brand WHERE brand_id = '" + brandID + "'";
        PreparedStatement ps = connection.prepareStatement(sql);
        ResultSet rs = ps.executeQuery();
        Brand brand = new Brand();
        while (rs.next()) {
...
public boolean insert(Brand c) throws SQLException {
    try {
         Connection connection = DBConnect.getConnecttion();
         String sql = "INSERT INTO musicshop.brand VALUE(?,?)";
         PreparedStatement ps = connection.prepareStatement(sql);
...
public boolean update(Brand c) throws SQLException {
    try {
         Connection connection = DBConnect.getConnecttion();
         String sql = "UPDATE musicshop.brand SET brand_name = ? WHERE brand_id = ?";
         PreparedStatement ps = connection.prepareStatement(sql);
...
public boolean delete(long brand_id) throws SQLException {
    try {
        Connection connection = DBConnect.getConnecttion();
        String sql = "DELETE FROM musicshop.brand WHERE brand_id = ?";
        PreparedStatement ps = connection.prepareStatement(sql);
 ...
 public boolean insertBrand(Brand c) {
        Connection connection = DBConnect.getConnecttion();
        String sql = "INSERT INTO musicshop.brand VALUES(?,?)";
        try {
