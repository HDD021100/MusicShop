...
public class ProductGet {
   ...
   public ArrayList<Product> getListProductByNav(long categoryID, int firstResult, int maxResult) throws SQLException{
        ...
        String sql = "SELECT * FROM musicshop.product WHERE category_id = '" + categoryID + "' limit ?,?";
    ...
    public int countProductByCategory(long categoryID) throws SQLException{
        Connection connection = DBConnect.getConnecttion();
        String sql = "SELECT count(product_id) FROM musicshop.product WHERE category_id = '" + categoryID + "'";
        PreparedStatement ps = connection.prepareStatement(sql);
        ResultSet rs = ps.executeQuery();
        int count = 0;
        while (rs.next()) {
...
public ArrayList<Product> getListProductByCategory(long category_id) throws SQLException {
        Connection connection = DBConnect.getConnecttion();
        String sql = "SELECT * FROM musicshop.product WHERE category_id = '" + category_id + "'";
        PreparedStatement ps = connection.prepareStatement(sql);
        ResultSet rs = ps.executeQuery();
        ArrayList<Product> list = new ArrayList<>();
        while (rs.next()) {
...
public ArrayList<Product> getList3ProductByCategory(long category_id) throws SQLException {
        Connection connection = DBConnect.getConnecttion();
        String sql = "SELECT * FROM musicshop.product WHERE category_id = '" + category_id + "' LIMIT 3;";
        PreparedStatement ps = connection.prepareStatement(sql);
        ResultSet rs = ps.executeQuery();
        ArrayList<Product> list = new ArrayList<>();
        while (rs.next()) {
...
public ArrayList<Product> getListProductByBrand(long brand_id) throws SQLException {
        Connection connection = DBConnect.getConnecttion();
        String sql = "SELECT * FROM musicshop.product WHERE brand_id = '" + brand_id + "'";
        PreparedStatement ps = connection.prepareStatement(sql);
        ResultSet rs = ps.executeQuery();
        ArrayList<Product> list = new ArrayList<>();
        while (rs.next()) {
...
public ArrayList<Product> getListProductRelated(long category_id, long product_id) throws SQLException {
        Connection connection = DBConnect.getConnecttion();
        String sql = "SELECT * FROM musicshop.product WHERE category_id = '" + category_id + "' and product_id != '" + product_id + "'" ;
        PreparedStatement ps = connection.prepareStatement(sql);
        ResultSet rs = ps.executeQuery();
        ArrayList<Product> list = new ArrayList<>();
        while (rs.next()) {
...
public ArrayList<Product> getListProduct() throws SQLException {
        Connection connection = DBConnect.getConnecttion();
        String sql = "SELECT * FROM musicshop.product";
        PreparedStatement ps = connection.prepareStatement(sql);
        ResultSet rs = ps.executeQuery();
        ArrayList<Product> list = new ArrayList<>();
        while (rs.next()) {
...
public Product getProduct(long productID) throws SQLException {
     Connection connection = DBConnect.getConnecttion();
     String sql = "SELECT * FROM musicshop.product WHERE product_id = '" + productID + "'";
     PreparedStatement ps = connection.prepareStatement(sql);
     ResultSet rs = ps.executeQuery();
     Product product = new Product();
     while (rs.next()) {
...
public boolean insert(Product c) throws SQLException {
    try {
         Connection connection = DBConnect.getConnecttion();
         String sql = "INSERT INTO musicshop.product VALUE(?,?,?,?,?,?,?,?,?)";
         PreparedStatement ps = connection.prepareStatement(sql);
...
public boolean update(Product c) throws SQLException {
    try {
         Connection connection = DBConnect.getConnecttion();
         String sql = "UPDATE musicshop.product SET product_name = ? WHERE product_id = ?";
         PreparedStatement ps = connection.prepareStatement(sql);
         ps.setLong(1, c.getProductID());
         ps.setLong(2, c.getCategoryID());
         ps.setString(3, c.getProductName());
...
public boolean delete(long product_id) throws SQLException {
    try {
        Connection connection = DBConnect.getConnecttion();
        String sql = "DELETE FROM musicshop.product WHERE product_id = ?";
        PreparedStatement ps = connection.prepareStatement(sql);
 ...
 public boolean insertProduct(Product c) {
        Connection connection = DBConnect.getConnecttion();
        String sql = "INSERT INTO musicshop.product VALUES(?,?,?,?,?,?,?,?,?)";
        try {
            PreparedStatement ps = connection.prepareStatement(sql);
         ps.setLong(1, c.getProductID());
         ps.setLong(2, c.getCategoryID());
    ...
    public boolean updateProduct(Product c) {
       ...
       // String sql = "UPDATE product SET product_id = ?, category_id = ?, product_name = ?, product_image = ?, product_image_forward = ?, product_image_back = ?, product_price = ?, product_description = ? WHERE product_id = ?";
        String sql = "UPDATE musicshop.product SET product_id=?, category_id=?, product_name=?, brand_id=?, product_image=?, product_image_forward=?, product_image_back=?, product_price=?, product_description = ? WHERE product_id = ?";
