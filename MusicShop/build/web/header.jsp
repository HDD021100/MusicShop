                ...
                <div class="container">
                    <div class="header-left animated wow fadeInLeft" data-wow-delay=".5s">
                        <ul>
                            ...
                            <li><i class="glyphicon glyphicon-envelope" ></i><a href="mailto:contact@fptguitarshop.com">@fptguitarshop.com</a></li>
                            <li><i class="glyphicon glyphicon-earphone" ></i>+8493 555 9999</li>
