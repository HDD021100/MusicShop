...
function ValidateForm(){
	...
	// check if email is not entered in appropriate textbox or only spaces are present in textbox
                ...
                <div class="container">
                    <form action="UserServlet" method="POST">
                        <div class="col-md-6 login-do1 animated wow fadeInLeft" data-wow-delay=".5s">
                            ...
                            <div class="login-mail">
                                <input type="text" placeholder="Email" name="email" id="email" required onSubmit="return ValidateForm()">
